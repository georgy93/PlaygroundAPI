namespace Playground.UnitTests.Domain.OrderAggregate
{
    ...
    public class OrderTests
    {
        ...
        public OrderTests()
        {
            ...
            _defaultPaymentMethod = new PaymentMethod(CardType.Visa, "dada", "23232", "212", "Hahao", DateTime.Now.AddYears(2), _timeProvider);
        }
        ...
        public void Create_New_Order_Should_Succeed_And_Add_New_Domain_Event()
        {
            ...
            // Act
            var order = Order.New(_timeProvider, DefaultShippingAddress, DefaultBillingAddress, DefaultBuyerId, DefaultBuyerFullName, DefaultUserName, _defaultPaymentMethod);
